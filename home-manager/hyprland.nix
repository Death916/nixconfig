  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        # Screenshots
        "SUPER SHIFT, Space, exec, sh -c 'grim -g ''$(slurp)'' - | tee ~/Pictures/screenshots/$(date +%s).png | wl-copy'" # Screenshot selection to clipboard
        "SUPER SHIFT, Print, exec, sh -c 'grim - | tee ~/Pictures/screenshots/$(date +%s).png | wl-copy'" # Screenshot full screen to clipboard
      ];
