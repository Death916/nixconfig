  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "NONE, XF86AudioRaiseVolume, binde, ${pkgs.pamixer}/bin/pamixer --increase 5"
        "NONE, XF86AudioLowerVolume, binde, ${pkgs.pamixer}/bin/pamixer --decrease 5"
        "NONE, XF86MonBrightnessUp, binde, ${pkgs.brightnessctl}/bin/brightnessctl set +5%"
        "NONE, XF86MonBrightnessDown, binde, ${pkgs.brightnessctl}/bin/brightnessctl set 5%-"
